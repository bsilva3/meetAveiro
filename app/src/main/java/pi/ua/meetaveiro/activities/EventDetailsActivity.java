...
public class EventDetailsActivity extends AppCompatActivity implements DataReceiver {
    ...
    private void initImageSlider() {
        ...
        mPager.setAdapter(new AttractionImageSliderAdapter(EventDetailsActivity.this, imagesArray));
    ...
    public void requestRoutes(){
        ...
        new EventDetailsActivity.getRoutesFromServerTask().execute(jsonRequest.toString());
    }
    ...
    public void onResponseReceived(Object result) {
        ...
        try {
            ...
            Toast.makeText(EventDetailsActivity.this, "Connection error", Toast.LENGTH_LONG).show();
            return;
        }
