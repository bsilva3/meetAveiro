...
public class AttractionAdapter extends RecyclerView.Adapter<AttractionAdapter.ViewHolder> {
    ...
    public AttractionAdapter(List<Attraction> items, AttractionListFragment.OnAttractionSelectedListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).city);
