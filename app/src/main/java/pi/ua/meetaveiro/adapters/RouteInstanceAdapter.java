...
public class RouteInstanceAdapter extends RecyclerView.Adapter<RouteInstanceAdapter.MyViewHolder> implements Filterable, SectionTitleProvider{
    ...
    private OnRouteInstanceItemSelectedListener listener;
    ...
    public RouteInstanceAdapter(Context context, List<RouteInstance> routeList, OnRouteInstanceItemSelectedListener listener) {
     ...
     * activity.
     */
    public interface OnRouteInstanceItemSelectedListener {
