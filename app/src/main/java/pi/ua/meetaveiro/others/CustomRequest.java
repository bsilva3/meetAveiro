...
/**
 * Created by fabio on 19-05-2018.
 */
...
public class CustomRequest extends JsonRequest<JSONArray> {
     ...
     *
     * @see #MyjsonPostRequest(int, String, JSONArray, Response.Listener, Response.ErrorListener)
     */
     ...
     * <code>null</code>, <code>POST</code> otherwise.
     *
     * @see #MyjsonPostRequest(int, String, JSONObject, Response.Listener, Response.ErrorListener)
     */
